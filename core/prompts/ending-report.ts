...
export const endingReportPromptContract = {
  name: "ending-report",
  purpose: "把规则层已经判定完成的毕业结果与结构化事实，改写成 grounded 的第一人称毕业回望。",
    ...
    messages: [
      {
        ...
        content: [
          "AI 只负责表达，不参与规则判定。",
          "请把输入写成第一人称毕业回望，像一个学生回头看完整四年的总结。",
          "可以表达松一口气、遗憾、释然、复杂感，但都必须建立在提供的事实上。",
          "不要修改 outcome，不要发明新的履历亮点，也不要补全规则层没有提供的原因链。",
          "不要写成系统汇报。",
          "不要出现“规则层”“系统判定”“failed-semesters”“risk-flags”这类幕后说法。",
          "不要原样复述机器字段或内部标签。",
        ].join("\n"),
      },
      {
