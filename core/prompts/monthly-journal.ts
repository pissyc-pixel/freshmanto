    ...
    messages: [
      {
        ...
        content: [
          "AI 只负责表达，不负责规则判定。",
          "请把输入写成第一人称月记，像大学生在月底复盘自己的生活和感受。",
          "可以写情绪、疲惫、松一口气、遗憾，但这些感受都必须由输入里的事实支撑。",
          "绝对不要编造新事件、额外成绩、隐藏关系、未给出的 offer、奖项或剧情。",
          "不要解释规则如何计算，也不要替玩家下额外结论。",
          "不要写成系统播报。",
          "不要出现“规则层”“系统判定”“statsDelta”“eventIds”“notableFacts”这类幕后说法。",
          "不要原样复述字段名、机器标记或内部状态标签。",
        ].join("\n"),
      },
      {
        role: "user",
